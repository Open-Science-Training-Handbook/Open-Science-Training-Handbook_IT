...
Il seminario di formazione dovrebbe inoltre fornire un quadro generale sulle politiche in materia di proprietà intellettuale introdotte dalle università e degli enti pubblici di ricerca. È fondamentale far presente la necessità di identificare coloro che detengono il diritto d’autore o qualsiasi altro diritto annesso sul prodotto della ricerca. I detentori del diritto d’autore sono coloro che possono decidere se porre delle restrizioni qualora non ce ne fossero di default per effetto di una licenza. In relazione ai prodotti della ricerca, il detentore del diritto d’autore può essere un ricercatore, un editore, una società scientifica, un’istituzione di ricerca, un ente finanziatore, ecc.

In un contesto di scienza aperta e per un’archiviazione ottimale sul lungo termine, i file non dovrebbero essere compressi; si dovrebbero evitare formati proprietari o brevettati a favore di formati aperti basati su standard documentati. In questo modo si garantiscono l’accessibilità e la riusabilità del contenuto. Ad essere pubblicati e archiviati dovrebbero essere solo file non criptati. Esempi di formati aperti per file sono:
...
1. Capacità di utilizzare le risorse disponibili per operare la scelta della licenza per lavori di ricerca scritti più appropriata in base al livello desiderato di libertà/limitazione del ri-uso da parte di terzi.

2. Capacità di usare le risorse disponibili per operare la scelta della licenza per dati più appropriata, in base al livello desiderato di libertà/limitazione di riuso da parte di terzi.
